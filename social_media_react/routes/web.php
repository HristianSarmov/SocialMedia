...
use App\Http\Controllers\getallphotoscontroller;
...
Route::group(['middleware' => ['protectedPages']], function() {
	...
	Route::get('/gallery/{personID}', [gallerycontroller::class, 'openGallery']);
	Route::get('/getallphotos/{PersonID}', [getallphotoscontroller::class, 'getPhotos']);
});
