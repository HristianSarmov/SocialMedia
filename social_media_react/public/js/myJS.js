...
function openemojilist(postid) {
	document.getElementById("currentpost").setAttribute("value", postid);
}

function opencommentemojilist() {
	document.getElementById("action").setAttribute("value", "comment");
}

function openupdatecaptionemojilist() {
	document.getElementById("action").setAttribute("value", "updatecaption");
}

function opennewcaptionemojilist() {
	document.getElementById("action").setAttribute("value", "newcaption");
}